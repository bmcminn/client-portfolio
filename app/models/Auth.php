...
class Auth {
     ...
     * @param  any      $data    Whatever you want to put in the token; probably some user data
     * @param  int      $expires The length of time in seconds this token should exist; never expires
     * @return string            The token string generated by the system
     */
    public static function generateToken($data, int $expires=null) {
